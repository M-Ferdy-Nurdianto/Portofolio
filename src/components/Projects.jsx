                ...
                <div className="flex justify-center mt-auto gap-4">
                  {project.live_url && (
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/20 hover:border-emerald-500/40 rounded-xl transition-all duration-300 font-medium group/btn flex-1"
                    >
                  ...
                  {project.github_url && !project.live_url && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-white/20 rounded-xl transition-all duration-300 font-medium group/btn flex-1"
                    >
                      <FaGithub size={18} />
